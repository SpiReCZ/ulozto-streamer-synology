...
define('USER_HOST_ENABLED_CONF_PATH', '/var/packages/DownloadStation/etc/download/host_enabled.conf');
define('WGET', '/var/packages/DownloadStation/target/bin/synodlwget');
define('DOWNLOAD_STATION_USER_AGENT', "Mozilla/5.0 (Windows NT 6.1) AppleWebKit/535 (KHTML, like Gecko) Chrome/14 Safari/535");
define('DOWNLOAD_TIMEOUT', 40);
...
function shutDownFunction() {
	...
	if (NULL !== $last_error && E_ERROR === $last_error['type']) {
		LogError("PHP shutDown with error: " . json_encode($last_error));
	}
}
